...
export_graphviz(
        clf, 
        out_file="/Users/jonathansong/Research_Folder/peptide_tree.dot",
        feature_names=X1,
        class_names=target_names,
        rounded=True,
        filled=True
        )
# to convert .dot to .png in terminal,
# ls
# cd ./Research_Folder
# dot -Tpng peptide_tree.dot -o peptide_tree.png
"""
weights = clf.feature_importances_
for i in range(len(weights)):
    if weights[i] > 0.05:
        print(X1[i], "--", weights[i])
"""
